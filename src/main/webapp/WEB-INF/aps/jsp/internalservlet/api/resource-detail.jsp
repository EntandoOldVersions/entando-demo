...
<div class="entando-api api-resource-detail">
	...
	<!-- DESCRIPTION -->
	<p class="description"><s:property value="#apiResourceVar.description" /></p>
	<s:if test='%{#apiResourceVar.resourceName.equalsIgnoreCase("getService") || #apiResourceVar.resourceName.equalsIgnoreCase("getServices")}' >
		<p><a href="<wp:action path="/ExtStr2/do/Front/Api/Service/list.action" />"><wp:i18n key="ENTANDO_API_GOTO_SERVICE_LIST" /></a></p>
	</s:if>
	<!-- INFO -->
	<dl class="table-display">
		...
		<dt><wp:i18n key="ENTANDO_API_EXTENSION" /></dt>
			<dd>
