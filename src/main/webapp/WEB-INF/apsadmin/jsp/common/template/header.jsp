...
<p>
	<a class="noborder" href="http://www.entando.com/<s:property value="currentLang.code"/>/updates/" title="<s:text name="note.checkForUpdates" />">
		<img src="<wp:resourceURL/>administration/common/img/entando-logo.png" width="97" height="44" alt="" /> <span class="monospace version">version <wp:info key="systemParam" paramName="version" /></span>
	</a>
</p>
</div>
