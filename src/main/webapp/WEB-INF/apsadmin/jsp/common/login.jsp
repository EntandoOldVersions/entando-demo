...
<h1 class="raw centerText" style="color:#74961B;">Entando &ndash; <s:text name="title.login.intro" /></h1>
...
<fieldset id="fieldset_space"><legend><s:text name="login.authenticationInfo" /></legend>
	...
	<p class="centerText">
		<s:submit cssClass="button uppercase" name="backend_client_gui" value="normal" cssStyle="color:#000000;background-color:#B2DF27;"/>
		<s:submit cssClass="button uppercase" name="backend_client_gui" value="advanced" cssStyle="color:#000000;background-color:#B2DF27;"/>		
