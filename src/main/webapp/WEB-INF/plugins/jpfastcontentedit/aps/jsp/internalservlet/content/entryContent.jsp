...
<%//TODO disable these libraries if already included %>
<wp:headInfo type="JS" info="../../administration/common/js/moo-japs/moo-jAPS-0.2.js" />
<wp:headInfo type="JS" info="../../administration/common/js/calendar_wiz.js" />
<wp:headInfo type="JS" info="../../plugins/jpfastcontentedit/static/js/fckeditor/fckeditor.js" />
<c:set var="javascriptcode">
...
<wp:headInfo type="JS_RAW" info="${javascriptcode}" />
<div class="jpfastcontentedit-editor">
	...
	<ul class="menu horizontal tab-toggle-bar">
		<li><a href="#info" id="info_tab_quickmenu" class="tab-toggle"><abbr
				title="<s:text name="title.contentInfo" />"><s:text
						name="label.general" /></abbr></a></li>
		<s:iterator value="langs" id="lang">
			<li><a href="#<s:property value="#lang.code" />_tab"
				class="tab-toggle"><s:property value="#lang.descr" /></a></li>
		</s:iterator>
	</ul>
