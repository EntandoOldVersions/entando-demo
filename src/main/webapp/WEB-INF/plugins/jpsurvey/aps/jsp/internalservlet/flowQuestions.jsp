	...
	<dd>
		<s:iterator var="choice" value="#currentQuestion.choices" status="rowstatus" >
			...
			<s:if test="#choice.freeText">
				<%--  
				<label for="choiceIds-<s:property value="#rowstatus.index"/>" ><wp:i18n key="JPSURVEY_FREE_TEXT" /></label>
				--%>
					<label for="choiceIds-<s:property value="#rowstatus.index" />" ><wp:i18n key="JPSURVEY_INSERT_FREE_TEXT" /></label>&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;<wpsf:textfield useTabindexAutoIncrement="true" name="insertedFreeText" id="insertedFreeText" cssClass="text" />
				</p>
			</s:if>
			<s:else>
