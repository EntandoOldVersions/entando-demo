...
<content id="CNG45" typecode="CNG" typedescr="Generic Content"><descr>Top Story</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Title" attributetype="Text"><text lang="it">APP My Entando</text><text lang="en">MyEntando APP</text></attribute><attribute name="Abstract" attributetype="Longtext"><text lang="it">Questo widget mostra il titolo, l''abstract e immagine di un contenuto generico del portale.</text><text lang="en">This widget shows you title, abstract and image of a generic content of the portal.</text></attribute><attribute name="Body" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>
	La APP My Entando consente all&#39;utente di <strong>creare</strong> il <strong>proprio desktop</strong> in maniera <strong>flessibile</strong> e <strong>dinamica</strong>.</p>
<p>
	Un <strong>cruscotto configurabile</strong> che consente agli utenti di accedere da dispositivi <strong>Tablet</strong> e <strong>smartphone</strong> alle informazioni e ai servizi di un portale realizzato con la piattaforma Entando.</p>
<p>
	MyEntando offre un modo <strong>semplice</strong> e <strong>innovativo</strong> per <strong>divulgare</strong> in maniera automatica <strong>informazioni</strong>, <strong>dati</strong> e <strong>servizi</strong> di un portale attraverso un interfaccia grafica e un layout specifico per dispositivi tablet e smartphone.</p>
]]></hypertext><hypertext lang="en"><![CDATA[<p>
	My Entando APP <strong>allows</strong> <strong>user</strong> to <strong>create</strong> a <strong>customized</strong> <strong>desktop</strong> in a flexible and dynamic way.</p>
<p>
	A <strong>configurable dashboard</strong> that enables users to <strong>access</strong> from Smartphones and Tablet to <strong>information</strong> and <strong>services</strong> of a portal built on Entando platform.</p>
<p>
	My Entando offers an easy and innovative way to automatically disclose information, data and services of a portal through a graphical interface and a specific layout for tablet devices and smartphones.</p>
]]></hypertext></attribute><attribute name="Image1" attributetype="Image"><resource resourcetype="Image" id="54" lang="en" /><text lang="en">MyEntando APP</text></attribute><attribute name="Image2" attributetype="Image" /><list attributetype="Monolist" name="Attach" nestedtype="Attach" /><list attributetype="Monolist" name="Links" nestedtype="Link" /></attributes><status>PUBLIC</status><version>19.0</version><lastEditor>jeff</lastEditor><created>20110926155919</created><lastModified>20130312123554</lastModified></content>
', '20110926155919', '20130312123554', '<?xml version="1.0" encoding="UTF-8"?>
<content id="CNG45" typecode="CNG" typedescr="Generic Content"><descr>Top Story</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Title" attributetype="Text"><text lang="it">APP My Entando</text><text lang="en">MyEntando APP</text></attribute><attribute name="Abstract" attributetype="Longtext"><text lang="it">Questo widget mostra il titolo, l''abstract e immagine di un contenuto generico del portale.</text><text lang="en">This widget shows you title, abstract and image of a generic content of the portal.</text></attribute><attribute name="Body" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>
	La APP My Entando consente all&#39;utente di <strong>creare</strong> il <strong>proprio desktop</strong> in maniera <strong>flessibile</strong> e <strong>dinamica</strong>.</p>
<p>
	Un <strong>cruscotto configurabile</strong> che consente agli utenti di accedere da dispositivi <strong>Tablet</strong> e <strong>smartphone</strong> alle informazioni e ai servizi di un portale realizzato con la piattaforma Entando.</p>
...
]]></hypertext></attribute><attribute name="Image1" attributetype="Image"><resource resourcetype="Image" id="67" lang="en" /><text lang="en">Entando 3.2</text></attribute><attribute name="Image2" attributetype="Image" /><list attributetype="Monolist" name="Attach" nestedtype="Attach" /><list attributetype="Monolist" name="Links" nestedtype="Link" /></attributes><status>PUBLIC</status><version>8.0</version><lastEditor>jeff</lastEditor><created>20110926140558</created><lastModified>20130311170700</lastModified></content>
', '20110926140558', '20130311170700', '<?xml version="1.0" encoding="UTF-8"?>
<content id="NEW17" typecode="NEW" typedescr="News"><descr>Entando version 3.2</descr><groups mainGroup="free"><group name="free" /></groups><categories><category id="news" /></categories><attributes><attribute name="Title" attributetype="Text"><text lang="it">Ecco le novità di Entando 3.2</text><text lang="en">Entando 3.2 Release News</text></attribute><attribute name="Date" attributetype="Date"><date>20131202</date></attribute><attribute name="Abstract" attributetype="Longtext"><text lang="it">Tante le novità presenti nella nuova versione, Entando 3.2, frutto di un percorso evolutivo che soddisfa le esigenze di aziende, sviluppatori e utenti finali.</text><text lang="en">A lot of innovations and improvements in Entando 3.2 release, result of an evolutionary process that meets the needs of enterprises, developers and users.</text></attribute><attribute name="Body" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>
	Tante le novit&agrave; presenti nella nuova versione, Entando 3.2, frutto di un percorso evolutivo che soddisfa le esigenze di aziende, sviluppatori e utenti finali.</p>
<p>
	Gli elementi caratterizzanti e innovativi di questa nuova release riguarderanno diversi temi, in particolare rivolti a semplificare e velocizzare le fasi di sviluppo per aziende e sviluppatori che utilizzano Entando, come ad esempio l&#39;introduzione di novit&agrave; che consentiranno una pi&ugrave; rapida e semplice installazione del sistema e di tutti i suoi componenti e lo switch immediato da un DBMS ad un altro.<br />
...
<content id="NEW33" typecode="NEW" typedescr="News"><descr>New Customer Services</descr><groups mainGroup="administrators" /><categories><category id="news" /></categories><attributes><attribute name="Title" attributetype="Text"><text lang="it">Nuovi servizi per i clienti</text><text lang="en">New customer Services</text></attribute><attribute name="Date" attributetype="Date"><date>20131127</date></attribute><attribute name="Abstract" attributetype="Longtext"><text lang="it">Nuovi servizi per i clienti sono disponibili nell''area riservata</text><text lang="en">New services for customers are available in the reserved area.</text></attribute><attribute name="Body" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>
...
<content id="NEW66" typecode="NEW" typedescr="News"><descr>News Widget Description</descr><groups mainGroup="free"><group name="free" /></groups><categories><category id="news" /></categories><attributes><attribute name="Title" attributetype="Text"><text lang="it">Questo widget ti consente di accedere alle ultime newsi accedere alle ultime news</text><text lang="en">This widget allows to access to the latest news and stay tuned!</text></attribute><attribute name="Date" attributetype="Date"><date>20131223</date></attribute><attribute name="Abstract" attributetype="Longtext"><text lang="it">Questo widget mostra le ultime news in base alla gruppo di appartenenza dell''utente.</text><text lang="en">This widget shows the latest news based on to the user group!</text></attribute><attribute name="Body" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>
...
]]></hypertext></attribute><attribute name="Image1" attributetype="Image"><resource resourcetype="Image" id="65" lang="en" /><text lang="en">Entando Logo</text></attribute><attribute name="Image2" attributetype="Image" /><list attributetype="Monolist" name="Attach" nestedtype="Attach" /><list attributetype="Monolist" name="Links" nestedtype="Link" /></attributes><status>PUBLIC</status><version>3.0</version><lastEditor>jeff</lastEditor><created>20130311152342</created><lastModified>20130311170922</lastModified></content>
', '20130311152342', '20130311170922', '<?xml version="1.0" encoding="UTF-8"?>
<content id="NEW66" typecode="NEW" typedescr="News"><descr>News Widget Description</descr><groups mainGroup="free"><group name="free" /></groups><categories><category id="news" /></categories><attributes><attribute name="Title" attributetype="Text"><text lang="it">Questo widget ti consente di accedere alle ultime newsi accedere alle ultime news</text><text lang="en">This widget allows to access to the latest news and stay tuned!</text></attribute><attribute name="Date" attributetype="Date"><date>20131223</date></attribute><attribute name="Abstract" attributetype="Longtext"><text lang="it">Questo widget mostra le ultime news in base alla gruppo di appartenenza dell''utente.</text><text lang="en">This widget shows the latest news based on to the user group!</text></attribute><attribute name="Body" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>
	Questo widget mostra le ultime news in base alla gruppo di appartenenza dell&#39;utente.</p>
]]></hypertext><hypertext lang="en"><![CDATA[<p>
	This widget shows the latest news based on to the user group!</p>
...
<content id="NEW70" typecode="NEW" typedescr="News"><descr>Entando 3.2 Webinar</descr><groups mainGroup="free" /><categories><category id="events" /></categories><attributes><attribute name="Title" attributetype="Text"><text lang="en">Entando 3.2 Webinar</text></attribute><attribute name="Date" attributetype="Date"><date>20131030</date></attribute><attribute name="Abstract" attributetype="Longtext" /><attribute name="Body" attributetype="Hypertext"><hypertext lang="en"><![CDATA[<p>
...
]]></hypertext></attribute><attribute name="Image1" attributetype="Image"><resource resourcetype="Image" id="69" lang="en" /><text lang="en">The future</text></attribute><attribute name="Image2" attributetype="Image" /><list attributetype="Monolist" name="Attach" nestedtype="Attach" /><list attributetype="Monolist" name="Links" nestedtype="Link" /></attributes><status>PUBLIC</status><version>1.0</version><lastEditor>jeff</lastEditor><created>20130311164815</created><lastModified>20130311164815</lastModified></content>
', '20130311164815', '20130311164815', '<?xml version="1.0" encoding="UTF-8"?>
<content id="NEW70" typecode="NEW" typedescr="News"><descr>Entando 3.2 Webinar</descr><groups mainGroup="free" /><categories><category id="events" /></categories><attributes><attribute name="Title" attributetype="Text"><text lang="en">Entando 3.2 Webinar</text></attribute><attribute name="Date" attributetype="Date"><date>20131030</date></attribute><attribute name="Abstract" attributetype="Longtext" /><attribute name="Body" attributetype="Hypertext"><hypertext lang="en"><![CDATA[<p>
	We would like to invite you to a special webinar for the latest enhancements to Entando 3.2 Release.</p>
<p>
	The Webinar will be a great opportunity for learning and get up to speed with the significant new developments Entando has brought to simplification and generalization of Entando installation, API Engine module, development of the front-end with Bootstrap framework and introduction of new components, Bundles, that allow customization and specialization of the graphic elements and functions of the base platform.</p>
...
]]></hypertext></attribute><attribute name="Image1" attributetype="Image"><resource resourcetype="Image" id="72" lang="en" /><text lang="en">Events</text></attribute><attribute name="Image2" attributetype="Image" /><list attributetype="Monolist" name="Attach" nestedtype="Attach" /><list attributetype="Monolist" name="Links" nestedtype="Link" /></attributes><status>PUBLIC</status><version>2.0</version><lastEditor>jeff</lastEditor><created>20130311165733</created><lastModified>20130311171550</lastModified></content>
', '20130311165733', '20130311171550', '<?xml version="1.0" encoding="UTF-8"?>
<content id="NEW71" typecode="NEW" typedescr="News"><descr>Events Widget Description</descr><groups mainGroup="free"><group name="free" /></groups><categories><category id="events" /></categories><attributes><attribute name="Title" attributetype="Text"><text lang="it">Questo widget mostra gli ultimi eventi in base al gruppo di appartenenza dell''utente.</text><text lang="en">This widget shows the latest events based on the user group.</text></attribute><attribute name="Date" attributetype="Date"><date>20131223</date></attribute><attribute name="Abstract" attributetype="Longtext"><text lang="it">Questo widget mostra gli ultimi eventi in base al gruppo di appartenenza dell''utente.</text><text lang="en">This widget shows the latest events based on the user group.</text></attribute><attribute name="Body" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>
	Questo widget mostra gli ultimi eventi in base al gruppo di appartenenza dell&#39;utente.</p>
]]></hypertext><hypertext lang="en"><![CDATA[<p>
	This widget shows the latest events based on the user group.</p>
...
', 'free', '3.0', 'jeff');
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor) VALUES ('CNG77', 'CNG', 'Content Widget', 'PUBLIC', '<?xml version="1.0" encoding="UTF-8"?>
<content id="CNG77" typecode="CNG" typedescr="Generic Content"><descr>Content Widget</descr><groups mainGroup="administrators"><group name="administrators" /></groups><categories /><attributes><attribute name="Title" attributetype="Text"><text lang="en">Content Widget</text></attribute><attribute name="Abstract" attributetype="Longtext"><text lang="en">Editors can manage the content directly from the front-end through the "Edit Content" button or from the cms interface through the "Edit Content Backoffice" shortcut.</text></attribute><attribute name="Body" attributetype="Hypertext"><hypertext lang="en"><![CDATA[<p>
	This widget shows you abstract of a content of the portal.</p>
<p>
...
]]></hypertext></attribute><attribute name="Image1" attributetype="Image"><resource resourcetype="Image" id="76" lang="en" /><text lang="en">Entando Editing</text></attribute><attribute name="Image2" attributetype="Image" /><list attributetype="Monolist" name="Attach" nestedtype="Attach" /><list attributetype="Monolist" name="Links" nestedtype="Link" /></attributes><status>PUBLIC</status><version>2.0</version><lastEditor>jeff</lastEditor><created>20130312123217</created><lastModified>20130312124151</lastModified></content>
', '20130312123217', '20130312124151', '<?xml version="1.0" encoding="UTF-8"?>
<content id="CNG77" typecode="CNG" typedescr="Generic Content"><descr>Content Widget</descr><groups mainGroup="administrators"><group name="administrators" /></groups><categories /><attributes><attribute name="Title" attributetype="Text"><text lang="en">Content Widget</text></attribute><attribute name="Abstract" attributetype="Longtext"><text lang="en">Editors can manage the content directly from the front-end through the "Edit Content" button or from the cms interface through the "Edit Content Backoffice" shortcut.</text></attribute><attribute name="Body" attributetype="Hypertext"><hypertext lang="en"><![CDATA[<p>
	This widget shows you abstract of a content of the portal.</p>
<p>
	Editors can manage the content using the two options available in the &quot;configure&quot; menu of the widget:</p>
